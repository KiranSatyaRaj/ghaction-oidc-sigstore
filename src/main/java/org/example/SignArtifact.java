...
public class SignArtifact {
    public static void main(String[] args) throws OidcException, InvalidAlgorithmParameterException, CertificateException, IOException, NoSuchAlgorithmException, InvalidKeySpecException, InvalidKeyException, KeylessSignerException {
